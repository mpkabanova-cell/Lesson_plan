...
- Если в запросе пользователя есть блок «КОНТЕКСТ ФРП» — subjectMaterials и trialActionIdea строй по фрагменту рабочей программы (конкретные тексты, задачи, источники, данные).
