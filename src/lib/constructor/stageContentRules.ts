...
export const STAGE_CONTENT_RULES: Partial<Record<string, StageContentRule>> = {
  problem_situation_goal: {
    ...
    requiredPatterns: ["цел", "вопрос", "план", "задач"],
    requiresTasks: true,
    minTasks: 1,
  },
  knowledge_activation: {
    ...
    requiredPatterns: ["вспомн", "изуч", "карт", "текст", "схем", "выполн", "ответ"],
    requiresTasks: true,
    minTasks: 1,
  },
  primary_acquisition: {
    forbidden: ["рефлексия", "фронтальный опрос", "опрос класса", "проектная работа", "групповой проект"],
    requiredPatterns: ["блок", "вывод", "схем", "таблиц", "источник", "текст", "карт", "формул"],
    requiresTasks: true,
    minTasks: 1,
  },
  physical_break: {
    forbidden: ["объяснение нового материала", "контроль знаний", "домашнее задание", "рефлексия"],
    requiredPatterns: ["встан", "потян", "наклон", "поворот", "дых"],
  },
  ...
  homework_info: {
    forbidden: [
      ...
      "по желанию",
      "пожелание",
      "запишите в дневник базовое",
      "запишите в дневник повышенное",
      "запишите в дневник базовый",
      "запишите в дневник повышенный",
      "записать в дневник базовое",
      "записать в дневник повышенное",
    ],
    requiredPatterns: ["реш", "выполн", "задани", "упражнен", "пример", "задач", "ответ"],
    requiresTasks: true,
    minTasks: 2,
  },
