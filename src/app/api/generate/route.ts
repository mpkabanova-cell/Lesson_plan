...
function buildUserPayload(b: Body): string {
  ...
  return [
    ...
    "Оформление: основной сценарий — таблица lesson-plan-table с колонками этапа, цели, действий учителя и учеников, задания и времени; формулы — LaTeX в span data-latex (см. системный промпт).",
    "В «Действиях учеников» укажи ожидаемые верные ответы на ключевые вопросы; обсуждение типичных ошибок с классом выдели явно (отдельная помеченная часть в «Действиях учителя»). Без общих фраз без предметного содержания.",
