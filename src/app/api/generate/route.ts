...
function buildUserPayload(b: Body): string {
  ...
  return [
    ...
    "Оформление: используй списки и таблицы HTML там, где они упрощают материал; формулы и обозначения — в духе предмета (школьная запись, при необходимости теги sub/sup).",
