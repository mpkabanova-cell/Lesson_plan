...
function buildUserPayload(b: Body): string {
  ...
  return [
    ...
    "Если в системном промпте предусмотрен раздел «Ключи к заданиям», выведи ответы к проверяемым заданиям только там; не перегружай ход урока лишними разборами.",
