...
function buildUserPayload(b: Body, fixBlock?: string): string {
  ...
  const parts = [
    ...
    "Нумерация заданий: «Задание N.M» — N = номер этапа в этом сценарии (по списку выше), M = номер задания внутри этапа. В **Ключи к заданиям** указывай только те номера, которые реально есть в блоках «Задание / материал»; не придумывай задания «в воздухе».",
